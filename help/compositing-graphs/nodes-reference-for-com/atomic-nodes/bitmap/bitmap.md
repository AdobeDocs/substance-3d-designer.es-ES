...
<div data-preserve-html="true" align="center"><img src="bitmap.resources/bitmap-tooltip.gif" alt="información sobre herramientas de mapa de bits" /></div>
...
| <b>Método Resize</b> *Entero* | Método de remuestreo que se utiliza para aumentar o reducir la escala de un mapa de bits:<ul data-preserve-html="true"> <li data-preserve-html="true"><i>estirar suavemente:</i> Aplica [filtrado bilineal](../../../../glossary/glossary.md) para interpolar sobre los píxeles de origen de la imagen estirada.</li> <li data-preserve-html="true"><i>estiro más cercano:</i> Estire la imagen y use el color del píxel de origen más cercano tal cual.</li> </ul> |
