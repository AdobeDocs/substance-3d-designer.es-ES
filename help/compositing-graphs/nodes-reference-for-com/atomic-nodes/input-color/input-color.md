...
breadcrumb-title: ""
description: Utilice el nodo Color de entrada para crear parámetros de entrada de color para gráficos de Substance que los usuarios pueden exponer y ajustar.
...
![Nodo atómico: Color de entrada](input-color.resources/comp_inputcolor_1.png "Nodo atómico: Color de entrada"){width="20%"}
...
Consulte también: [Escala de grises de entrada](../input-grayscale/input-grayscale.md), [Valor de entrada](../input-value/input-value.md)

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="Información sobre herramientas de color de entrada" /></div>
...
![Entrada principal en el gráfico del Substance](input-color.resources/node-primary-input.png){width="20%"}
