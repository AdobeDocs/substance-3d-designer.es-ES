...
![Nodo atómico: Color de entrada](input-color.resources/comp_inputcolor_1.png "Nodo atómico: Color de entrada"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="input-color.resources/input-color-tooltip.gif" alt="Información sobre herramientas de color de entrada" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
...
![Entrada principal en el gráfico del Substance](input-color.resources/node-primary-input.png)
