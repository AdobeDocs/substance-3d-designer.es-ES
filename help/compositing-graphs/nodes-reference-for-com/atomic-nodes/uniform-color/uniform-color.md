...
![Nodo atómico: Uniform color](uniform-color.resources/comp_uniform_1.png "Atomic node: Color uniforme"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="uniform-color.resources/uniform-color-tooltip.gif" alt="información sobre herramientas de uniforme de color" /></div>
