...
![Nodo atómico: Entrada en escala de grises](input-grayscale.resources/comp_inputgrayscale_1.png "Nodo atómico: Escala de grises de entrada"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="Información sobre herramientas de escala de grises" /></div>
...
![Entrada principal en el gráfico del Substance](input-grayscale.resources/node-primary-input.png){width="20%"}
