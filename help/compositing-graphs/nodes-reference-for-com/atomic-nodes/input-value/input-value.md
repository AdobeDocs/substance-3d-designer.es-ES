...
![Nodo atómico: Valor de entrada](input-value.resources/comp_inputnumeric_1.png "Nodo atómico: Valor de entrada")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-value.resources/input-value-tooltip.gif" alt="Información sobre el valor de entrada" /></div>
