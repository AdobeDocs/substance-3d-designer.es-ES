...
![Nodo atómico: Valor de entrada](input-value.resources/comp_inputnumeric_1.png "Nodo atómico: Valor de entrada"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="Información sobre el valor de entrada" /></div>
...
![Entrada principal en el gráfico del Substance](input-value.resources/node-primary-input.png){width="20%"}
