...
![Icono de nodo](paths-vertex-processor-simple.resources/paths-vertex-processor-simple-icon.png "Icono de nodo")
...
![Ejemplo de nodo 2](paths-vertex-processor-simple.resources/PathsVertexProcessor-Demo2.gif "Ejemplo de nodo 2")
