...
![Trazados Salida de polígono](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-01.jpg "Trazados Salida de polígono")
...
![Cúbica polinomial en vista 2D](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-02.gif "Cúbica polinomial en vista 2D")
...
![Herramientas de ruta en la biblioteca](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-03.jpg "Herramientas de ruta en la biblioteca")
...
![Nodos de generación de rutas](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-04.jpg "Nodos de generación de rutas"){width="600px"}

### Edición de trazados

[Transformación 2D de trazado](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/path-tools/path-2d-transform/path-2d-transform.md), [Deformación de trazados](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/path-tools/paths-warp/paths-warp.md) y [Transformación cuádruple en trazado](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/path-tools/quad-transform-on-path/quad-transform-on-path.md) te permiten editar la forma de los trazados.
...
Este nodo no tiene resultados. Haga doble clic en LMB en el nodo para mostrar la vista previa en [Vista 2D](../../../../../interface/2d-view/2d-view.md).
...
![Nodo de rutas de vista previa](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-05.jpg "Nodo de rutas de vista previa")
...
![Ruta a la spline](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-06.jpg "Ruta a la spline")
...
![Herramientas de spline en la biblioteca](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-07.jpg "Herramientas de spline en la biblioteca")
...
![Anexar splines con modos de creación de vínculos](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-08.gif "Anexar splines con modos de creación de vínculos")
...
![Salida de vista previa en nodo de spline](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-09.jpg "Salida de vista previa en nodo de spline")
...
![Spline procesado como segmentos](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-10.jpg "Spline procesado como segmentos")
