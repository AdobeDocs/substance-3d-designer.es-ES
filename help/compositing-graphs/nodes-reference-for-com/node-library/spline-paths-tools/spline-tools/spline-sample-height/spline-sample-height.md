...
<b>Mapa de Height</b> *Escala de grises* Imagen de entrada en escala de grises utilizada para cambiar el height de la spline de entrada.
...
<b>Modo de muestreo</b> *Integer* Método de asignación de los valores de la asignación de Height a las splines:\
...
<b>Opacidad</b> *Float* Un multiplicador para la intensidad de la contribución de la entrada del mapa de Height al height de la spline.<b></b>

<b>Modo De Fusión</b> *Integer* Método para mezclar los datos del mapa de Height con el height de la spline de entrada:\
*- Copia*: Anular el height de la spline con los valores de Mapa de Height;\
*- Agregar*: Añada los valores de Mapa de Height al height de la spline;\
*- Restar*: Restar los valores de Mapa de Height al height de la spline;\
*- Multiplicar*: Multiplique los valores de Mapa de Height contra el height de la spline.
