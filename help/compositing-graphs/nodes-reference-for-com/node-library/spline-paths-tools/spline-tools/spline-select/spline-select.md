...
![Icono de nodo](spline-select.resources/spline-select-01.png "Icono de nodo")
...
![Ejemplo de nodo 1](spline-select.resources/spline-select-06.gif "Ejemplo de nodo 1")
