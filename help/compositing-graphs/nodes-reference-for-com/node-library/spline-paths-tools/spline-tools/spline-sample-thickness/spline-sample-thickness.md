...
![Icono de nodo](spline-sample-thickness.resources/spline-sample-thickness-icon.png "Icono de nodo")
...
![Ejemplo de nodo 1](spline-sample-thickness.resources/SplineSampleThickness-Variant1-After1.jpg "Ejemplo de nodo 1")

</td>
<td style="border: 0;" valign="top">

![Ejemplo de nodo 2](spline-sample-thickness.resources/SplineSampleThickness-Demo.gif "Ejemplo de nodo 2")
