...
<b>Mapa de color </b>*Color* Imagen de color de entrada que se debe asignar a las splines de entrada.

## Conectores de salida

<b>Color</b> *Escala de grises* Resultado de asignar la imagen de color de entrada a través de las splines sobre el fondo, como una imagen en color.
