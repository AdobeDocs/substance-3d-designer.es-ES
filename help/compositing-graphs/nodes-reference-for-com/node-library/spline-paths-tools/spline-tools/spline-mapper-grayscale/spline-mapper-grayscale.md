...
# Spline Mapper Escala de grises

<table>
<tr style="border: 0;">
<td width="33.33%" style="border: 0;" valign="top">

![Icono de nodo](spline-mapper-grayscale.resources/spline-mapper-grayscale-01.png "Icono de nodo")
...
Asigna una imagen de escala de grises de entrada a una forma simple estirada a lo largo de las splines de entrada.
...
El nodo emite la imagen asignada como una imagen en escala de grises, así como otra información como el height, las UV (es decir, las coordenadas de imagen) y una máscara de ID para seleccionar cada spline asignada de forma independiente.
...
>[!NOTE]
>
> Vea también [Color del asignador de spline](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-color/spline-mapper-color.md).
...
| <b>Mapa de color</b> <i>Escala de grises</i> | Imagen de escala de grises de entrada que se debe asignar a lo largo de las splines de entrada. |
...
|  |  |
|:---|:---|
| <b>Color</b> <i>Escala de grises</i> | El resultado de asignar la imagen de color de entrada a través de las splines de entrada, como una imagen en escala de grises. |
...
![Ejemplo de nodo 2](spline-mapper-grayscale.resources/spline-mapper-grayscale-04.gif "Ejemplo de nodo 2")
...
![Ejemplo de nodo 3](spline-mapper-grayscale.resources/spline-mapper-grayscale-05.jpg "Ejemplo de nodo 3")
