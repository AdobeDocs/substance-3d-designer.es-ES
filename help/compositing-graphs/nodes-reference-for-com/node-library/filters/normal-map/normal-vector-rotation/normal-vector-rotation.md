...
breadcrumb-title: ''
description: Utilice el nodo Rotación de vectores normales para rotar vectores de mapa de normales para ajustar la iluminación de la superficie y la orientación de los detalles.
...
Nodo de utilidad normal que gira todos los vectores de un mapa normal de entrada en el espacio Tangente. En realidad no transforma píxeles, sino que modifica los valores que representan. Puede utilizar un mapa opcional para añadir rotaciones aleatorias a facetas en escala de grises.
