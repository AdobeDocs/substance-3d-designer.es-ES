...
breadcrumb-title: ''
description: Utilice el nodo Normal doblado para generar mapas de normales doblados que tengan en cuenta la oclusión ambiental y la iluminación indirecta.
...
![Icono de nodo normal doblado](bent-normal.resources/rt-bent-normal.png "Icono de nodo normal doblado")
...
Genera un Mapa de normales doblado basado en la entrada de un mapa de altura. Un Mapa de normales doblado es una versión especial de [Normal](../../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md) y [Oclusión ambiental (RTAO)](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/ambient-occlusion-rtao/ambient-occlusion-rtao.md), que generan un mapa de normales con oclusión ambiental incrustada.\
Esto se puede utilizar en motores en tiempo real para que la Oclusión ambiental se haga un bake en el mapa normal, por ejemplo para obtener reflejos de oclusión más precisos sobre los metales.
...
| <b>Tamaño físico</b> <i>Flotante3</i> | (Disponible cuando <b>Usar Tamaño físico</b> está establecido en <i>Verdadero</i>) Ajusta la escala de height en función del tamaño físico real de la superficie. |
...
| <b>Escala de Height</b> <i>Flotante</i> | (Disponible cuando Usar Tamaño físico está establecido en Falso) Multiplicador para la intensidad de la entrada del mapa de altura. |
