...
breadcrumb-title: ''
description: Utilice el nodo Fusión de luminosidad para fusionar texturas basadas en valores de luminosidad para crear efectos compuestos basados en el brillo.
