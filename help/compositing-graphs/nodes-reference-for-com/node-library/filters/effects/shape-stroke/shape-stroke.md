...
## Trazo de forma (escala de grises)
...
* **Ancho**: *-1.0 - 1.0* Ancho del efecto de trazo.
* **Opacidad**: *0.0 - 1.0*\
  Opacidad global del efecto.
* **(Contorno) Color**: *(Valor de color)*Color utilizado para el efecto de contorno.
