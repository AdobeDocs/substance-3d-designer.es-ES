...
Esta categoría contiene una gran variedad de nodos destinados a múltiples usos. Estos nodos están pensados principalmente para una entrada de un solo canal y realizan un efecto o modificación bastante avanzado como salida.

Utilice la <b>lista de navegación de la izquierda</b> para examinar todos los nodos en Efectos.

Un gran grupo de nodos está destinado a procesar, generar y modificar Mapas con bake, como Normalmap o AO y Curvature. Ejemplos:
...
* [Oclusión ambiental (HBAO)](../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/ambient-occlusion-hbao/ambient-occlusion-hbao-filter-node.md)

Otro grupo de nodos está diseñado para el efecto de forma de capa o &quot;Estilos de capa&quot;, como se ve en otro software de edición de imágenes popular. Ejemplos:
