...
breadcrumb-title: ''
description: Utilice el nodo SDF de la Textura 3D para generar texturas de campos de distancia firmados a partir de datos 3D para crear formas y efectos suaves.
...
El nodo **SDF de Textura 3D** genera el *campo de distancia firmado* de una forma a partir de la máscara *textura 3D* de **Input** que representa los sectores del *volumen* de la forma.
...
|  |  |
|:---|:---|
| <b>Entrada de máscara</b> <i>Escala de grises</i> | Máscara de <i>textura 3D</i> que representa los sectores del <i>volumen</i> de una forma. |
...
|  |  |
|:---|:---|
| <b>Umbral</b> <i>Flotante</i> | Cuando el volumen de la forma se describe mediante un <i>degradado</i>, establece el valor de degradado en el que se <i>detecta</i> la <i>superficie</i> de la forma. |
