...
![Icono de visor 3D](./3d-viewer.resources/3d-viewer.png "Visor 3D")
...
| <b>Distancia desde el destino</b> *Flotante* | Distancia que la cámara debe reposar desde la <b>posición de destino</b>.<br><br>Al ajustar esto, la cámara se mueve en la dirección de la cámara al objetivo. |
| <b>Posición de destino</b> *Flotante3* | La posición del objetivo de la cámara, hacia la que la cámara siempre está orientada. |
...
| <b>Número-F</b> *Flotante* | La <i>apertura</i> de la cámara.<br><br>Un valor más bajo tiene como resultado una <i>profundidad de campo</i> más corta, es decir, un rango de distancia más corto para los objetos que son nítidos y un efecto de desenfoque más fuerte a medida que aumenta la distancia desde ese rango. |
| <b>Distancia de enfoque</b> *Flotante* | Define la distancia del punto focal como una distancia desde la cámara a lo largo de su vector delantero.<br><br>Las superficies dentro del rango de esa distancia aparecerán nítidas, ese rango —la <i>profundidad del campo </i>— está definido por el <b>número F</b>. |
| <b>Exposición (VE)</b> *Flotante* | La cantidad de luz que llega al sensor de la cámara, es decir, la intensidad de la iluminación en el renderizado.<br><br>Un valor más bajo da como resultado una escena renderizada más oscura.<br><br>El valor de exposición (EV) se refiere específicamente a la cantidad de luz a la que está <i>expuesto</i> el sensor de la cámara. |
| <b>Color base</b> *Flotante3* | El color base por defecto para superficies en las que el color no está definido por su función SDF o de intersección. |
| <b>Rugosidad</b> *Flotante* | Valor de rugosidad por defecto para superficies en las que el valor no está definido por su función SDF o de intersección. |
| <b>Metalness</b> *Flotante* | Valor de metalidad por defecto para superficies en las que el valor no está definido por su función SDF o de intersección. |
| Opacidad de <b>Helpers</b> *Flotante* | Opacidad de los ayudantes 3D, donde un valor más bajo da como resultado ayudantes más débiles. |
| <b>marco delimitador</b> *Booleano* | Visualización de una jaula de seis lados que define los límites de toda la escena. Idealmente debe ser el tamaño más pequeño posible que incluya completamente la escena.<br><br>Use el parámetro <b>Tamaño de marco delimitador</b> para ajustar el tamaño de la jaula.<br><br>El parámetro <b>Colorear fuera del marco</b> te permite visualizar fácilmente las superficies fuera de esa jaula, lo que afecta al resultado de usar esa escena en el nodo [Shape splatter v2](../../../texture-generators/patterns/shape-splatter-v2/shape-splatter-v2.md) . (Consulte la información sobre herramientas &quot;Tamaño de marco delimitador&quot;) |
| <b>Tamaño de marco delimitador</b> *Flotante3* | Establece el tamaño XYZ del marco delimitador.<br><br>Ajusta el marco a la escena y luego aplica esos mismos valores al parámetro <b>SDF bound marco size</b> del nodo [Shape splatter v2](../../../texture-generators/patterns/shape-splatter-v2/shape-splatter-v2.md) para garantizar que ese nodo incluya y dibuje correctamente todas las formas de la escena. |
...
| <b>Mín. distancia de acceso </b> *Flotante* | Define la distancia mínima que se traduce en un éxito para el proceso de marcado de rayos SDF.<br><br>Un valor bajo aumentará el número de pasos de desplazamiento de rayos. |
...
<table style="border: none;">
    <tr style="width: 50%;">
        <td style="text-align: center">
            <img src="3d-viewer.resources/3d-viewer-example-01.jpg" alt="Ejemplo 1" />
        </td>
        <td style="width: 50%;">
            <table style="border: none;">
                <tr style="vertical-align: top;">
                    <td style="text-align: center">
                        <img src="3d-viewer.resources/3d-viewer-example-02a.jpg" alt="Ejemplo 1" />
                    </td>
                    <td style="text-align: center">
                        <img src="3d-viewer.resources/3d-viewer-example-02b.jpg" alt="Ejemplo 2" />
                    </td>
                </tr>
                <tr style="vertical-align: top;">
                    <td style="text-align: center">
                        <img src="3d-viewer.resources/3d-viewer-example-02c.jpg" alt="Ejemplo 3" />
                    </td>
                    <td style="text-align: center">
                        <img src="3d-viewer.resources/3d-viewer-example-02d.jpg" alt="Ejemplo 4" />
                    </td>
                </tr>
            </table>
    </tr>
