...
|                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:---------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Entorno</b> *Color* | La imagen que debe proyectarse en la esfera infinita se utiliza como entorno de la escena y para la iluminación del entorno.<br><br>La proyección es <i>equirectangular</i>, la misma que usan los mapas de entorno predeterminados de Designer disponibles en la categoría <b>Vista 3D > Entornos HDRI</b> de la biblioteca.<br><br>Cuando no está conectado, se usa un entorno predeterminado.<br><br><i>Sugerencia:</i> Use una imagen HDR (32 bits) para obtener una iluminación precisa. |
...
| <b>Función de cámara</b> *Float3* | Gráfico de funciones que define la transformación de la cámara. Esto se puede utilizar para configurar una cámara personalizada.<br><br>La función debe <b>establecer</b> estas variables:<br>- <code>view.source</code> (Float3) Posición del espacio de entorno por píxel de la vista de cámara.<br>- <code>view.direction</code> (Float3) Vector de avance por píxel de la vista de cámara, según el modo de proyección. (E.g. perspectiva u ortográfica)<br><br>Las siguientes variables están disponibles para <b>get</b>:<br>- <code>camera.source</code> (Float3) La posición espacial mundial de la cámara. (camera.direction * camera_distance + camera.target)<br>- <code>camera.direction</code> (Float3) La dirección del espacio mundial de la cámara, es decir, el vector Y-forward de la cámara.<br>- <code>camera.right</code> (Float3) El vector X-right de la cámara.<br>- <code>camera.up</code> (Float3) El vector Z-up de la cámara.<br>- <code>camera.target</code> (Float3) Posición del espacio mundial del objetivo de la cámara. |
...
| <b>Tónemapper</b> *Entero* | Algoritmo de asignación de tonos que se debe aplicar al procesamiento de la escena.<br><br>- <b>Ninguno (sin procesar)<br>- <b>sRGB</b><br>- <b>AgX</b><br>- <b>ACES</b> |
| <b>Habilitar profundidad de campo</b> *Booleano* | Simula el efecto de lente de cámara &quot;profundidad de campo&quot; para la cámara de perspectiva.<br><br>Usa los parámetros <b>Número F</b> y <b>Distancia de enfoque</b> para ajustar la apertura y el punto focal del efecto respectivamente.<br><br>El resultado también se ve afectado por la <b>Distancia focal</b>. |
...
| <b>Colorear fuera del marco</b> *Booleano* | Aplica un color rojo a las superficies fuera del marco delimitador.<br><br>Esto ayuda a comprobar que la escena está totalmente incluida en su fotograma delimitador. |
