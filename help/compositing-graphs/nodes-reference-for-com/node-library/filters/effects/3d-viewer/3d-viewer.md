...
| <b>Escena de SDF</b> *Flotante* | Función de campo de distancia firmada (SDF) que describe las superficies y formas de la escena.<br><br>Use los nodos de la categoría [Funciones SDF](../../../../../../function-graphs/nodes-reference-for-fun/function-node-library/function-node-library.md#sdf-functions) de la biblioteca para crear la función. |
| <b>Intersecar escena</b> *Flotante* | La función de intersección describe las superficies y formas de la escena.<br><br>Las funciones de intersección para simples primitivos y operadores están disponibles en las carpetas <b>3d_intersection</b> del paquete de biblioteca <b>3d_functions.sbs</b>.<br><br><i>Sugerencia:</i> Puede acceder al paquete colocando cualquier nodo SDF de la biblioteca en el Explorador. |
| <b>Salida</b> *Entero* | El tipo de renderizado 3D que debe generar el nodo, normalmente denominado AOV (Variables de salida arbitrarias).<br><br>Los AOV disponibles son:<br>- <b>Belleza:</b> El resultado final del renderizado 3D, con colores y efectos dirigidos por arte.<br>- <b>Normal WS:</b> Las normales de espacio de mundo de las formas de la escena.<br>- <b>Normal TS:</b> Las normales de espacio tangente de las formas de la escena.<br>- <b>Posición:</b> Posición del espacio de entorno de las superficies de las formas en la escena.<br>- <b>Distancia:</b> Distancia aproximada entre la cámara y las formas de la escena<br>- <b>Profundidad:</b> Distancia firmada entre las formas y el plano de destino de la cámara, donde el plano siempre mira a la cámara.<br>- <b>Color:</b> El color base de las formas (use el nodo &#39;Establecer color&#39; para asignar colores a las formas en la función de escena)<br>-<b>Id. Material: 24} Los identificadores de material aplicados a las superficies de formas (utilice el nodo &#39;Establecer id. de material&#39; para asignar identificadores de material a formas en la función de escena)<br>- <b>Pasos de seguimiento de esfera:</b> Una visualización de la cantidad de pasos necesarios para definir la superficie de una forma. </b>Los valores más brillantes significan que se requieren más pasos.<br>- <b>Personalizado:</b> Crea una función personalizada para calcular el color del procesamiento por píxel.<br><br><i>Nota:</i> Para obtener lecturas precisas en algunos archivos AOV, asegúrese de que el vista 2D usa un espacio de color lineal y el nodo usa un formato de salida HDR. de 32 bits. |
| <b>Salida personalizada</b> *Flotante4* | Gráfico de funciones que define los colores RGBA por píxel de la escena procesada como un valor Flotante4.<br><br>Variables disponibles:<br>- <code>scene.position</code> (Flotante3) Posición del espacio mundial de las superficies de la escena.<br>- <code>scene.normal</code> (Flotante3) El espacio normal de las superficies de la escena.<br>- <code>scene.hit</code> (Booleano) Devuelve &#39;True&#39; cuando una superficie es golpeada por un rayo de cámara.<br>- <code>view.source</code> (Flotante3) Posición del espacio de entorno por píxel de la vista de cámara.<br>- <code>view.direction</code> (Flotante 3) El vector de avance por píxel de la vista de cámara, según el modo de proyección. (E.g. Perspectiva o ortográfico)<br>- <code>material.color</code> (Flotante3) color base de las superficies de la escena.<br>- <code>material.metalness</code> (Flotante) Metalidad de las superficies de la escena.<br>- <code>material.roughness</code> (Flotante) Rugosidad de las superficies de la escena.<br>- <code>material.id</code> (Entero) Identificadores de material de las superficies de la escena.<br><br>Las entradas de imagen del nodo se pueden muestrear seleccionando las siguientes ranuras de nodo [Sample color](../../../../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/sampler-nodes/sampler-nodes.md):<br>- <b>Image input 0</b> samples Input 1.<br>- <b>Image input 1</b> samples Input 2. |
