...
| <b>Suavizado de contorno</b> *Flotador* | Controla el radio de un efecto de suavizado aplicado a la imagen de entrada, que se utiliza para simplificar la imagen cuantificada en formas más sólidas y cohesivas.   Nota: Este suavizado requiere cálculos intensivos, por lo que la elevación de este valor aumenta notablemente el tiempo de cálculo del nodo. |
