---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/filters/adjustments/modify-color-palette.html"
breadcrumb-title: ''
description: Utilice el nodo Modificar paleta de colores para ajustar y transformar las paletas de colores extraídas de las texturas.
...
|  |  |
|:---|:---|
| <b>Modo de selección de color</b> *Entero* | Método de selección del color de destino en la paleta que se debe modificar:<ul data-preserve-html="true"> <li data-preserve-html="true"><b>Índice de color:</b> Índice del color de destino</li> <li data-preserve-html="true"><b>Espacio de imagen:</b> Posición en el mapa de ID donde se debe muestrear el índice. Cuando se selecciona este modo, hay un gizmo de posición disponible en el vista 2D para facilitar la selección</li> </ul> |
| <b>Posición de color</b> *Flotante2* *Disponible cuando &#39;Modo de selección de color&#39; está establecido en &#39;Espacio de imagen&#39;* | Posición en el mapa de ID donde se debe muestrear el índice.   Utilice el gizmo del vista 2D para seleccionar fácilmente una ubicación en la imagen.   Sugerencia: Puede mostrar la imagen cuantificada de la que se extrae el mapa de ID y, a continuación, seleccionar el nodo Modificar paleta de colores para mostrar el gizmo. Esto hace que la selección de un color para modificarlo sea más intuitiva. |
...
| <b>Anular color</b> *Flotante3* *Disponible cuando &#39;Mode&#39; está establecido en &#39;Override color&#39;* | Especifica el color que debe sustituir al color original. |
| <b>HSL</b> *Flotante3* *Disponible cuando &#39;Mode&#39; está establecido en &#39;HSL&#39;* | Controla los desplazamientos de tono, saturación y luminosidad aplicados al color original. |
