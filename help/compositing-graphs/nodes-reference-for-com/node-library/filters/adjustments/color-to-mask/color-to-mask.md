...
|  |  |
| --- | --- |
| Color de <b>entrada</b> | Imagen de color de entrada de la que se debe extraer una máscara en función de sus colores. |
| <b>Entrada de color</b> Color *Disponible cuando &#39;Usar entrada de color&#39; está establecido en &#39;True&#39;* | Imagen de color de entrada utilizada para definir el color de referencia por píxel. |

## Salidas

|  |  |
| --- | --- |
| <b>Salida</b> *Escala de grises* | Máscara generada como mapa de bits en escala de grises. |

## Parámetros

|  |  |
| --- | --- |
| <b>Usar entrada de color</b> Boolean | Utilice una imagen de entrada en lugar de un color uniforme, para definir un color de referencia por píxel.    La entrada <b>Color input</b> proporciona la imagen de entrada. |
| <b>Color</b> Float3 *Disponible cuando &#39;Usar entrada de color&#39; está establecido en &#39;False&#39;* | Color uniforme de referencia alrededor del cual se debe realizar la selección de color. |
| Flotante <b>Umbral</b> | Distancia al color de referencia por debajo del cual se seleccionan los colores. |
