...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="gaussian-spots-1.resources/gaussian_spots_1_1.png" class="modal-image" alt="Manchas gaussianas 1 - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="gaussian-spots-1.resources/noise_gaussian_spots_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="Manchas gaussianas 1 - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="gaussian-spots-1.resources/noise_gaussian_spots_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="Manchas gaussianas 1 - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="gaussian-spots-1.resources/noise_gaussian_spots_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Manchas gaussianas 1 - Ejemplo 4" />
        </td>
