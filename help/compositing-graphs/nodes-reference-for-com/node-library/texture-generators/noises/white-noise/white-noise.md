...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="white-noise.resources/white_noise_v2_1.png" class="modal-image" alt="Ruido blanco - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="white-noise.resources/white_noise_v2_speed0.6_aniso0.gif" class="modal-image" alt="Ruido blanco - Ejemplo 2" />
        </td>
