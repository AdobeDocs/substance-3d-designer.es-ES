...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="directional-noise-4.resources/directional_noise_4_1.png" class="modal-image" alt="Ruido direccional 4 - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="directional-noise-4.resources/noise_directional_noise_4_v2_speed0.6_aniso0.gif" class="modal-image" alt="Ruido direccional 4 - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="directional-noise-4.resources/noise_directional_noise_4_v2_speed0.6_aniso1.gif" class="modal-image" alt="Ruido direccional 4 - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="directional-noise-4.resources/noise_directional_noise_4_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Ruido direccional 4 - Ejemplo 4" />
        </td>
