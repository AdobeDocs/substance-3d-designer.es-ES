---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/bnw-spots-2.html"
breadcrumb-title: ""
description: Utilice el nodo Manchas BnW 2 para crear patrones de manchas en blanco y negro con controles mejorados para variaciones de textura.
...
![Manchas BnW 2 - Icono](bnw-spots-2.resources/bnw_spots_2.png "Manchas BnW 2 - Icono"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/bnw_spots_2_1.png" class="modal-image" alt="Manchas BnW 2 - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Manchas BnW 2 - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="Manchas BnW 2 - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Manchas BnW 2 - Ejemplo 4" />
        </td>
