---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-gradient.html"
breadcrumb-title: ""
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-gradient.resources/dirt_gradient_1.png" class="modal-image" alt="Degradado de dirt - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-gradient.resources/noise_dirt_gradient_v2_speed0.6_aniso0.gif" class="modal-image" alt="Degradado de dirt - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-gradient.resources/noise_dirt_gradient_v2_speed0.6_aniso1.gif" class="modal-image" alt="Degradado de dirt - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-gradient.resources/noise_dirt_gradient_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Degradado de dirt - Ejemplo 4" />
        </td>
