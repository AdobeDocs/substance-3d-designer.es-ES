...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/fractal-voronoi-sea.gif" class="modal-image" alt="Voronoi Fractal - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/fractal-voronoi-scifi-panel.gif" class="modal-image" alt="Fractal de Voronoi - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant2.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 4" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant6.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 5" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant3.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 6" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant5.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 7" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant4.jpg" class="modal-image" alt="Fractal de Voronoi - Ejemplo 8" />
        </td>
