...
El nodo **Suciedad Galvánica Pequeña** genera un mapa de suciedades similar al patrón de acero densamente galvanizado.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant2.jpg" class="modal-image" alt="Suciedad Galvánica Pequeña - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant.jpg" class="modal-image" alt="Suciedad Galvánica Pequeña - Ejemplo 2" />
        </td>
