...
Consulte también: [Nubes 2](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/clouds-2/clouds-2.md), [Nubes 3](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/clouds-3/clouds-3.md)
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/clouds_1_1.png" class="modal-image" alt="Nubes 1 - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="Nubes 1 - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="Nubes 1 - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Nubes 1 - Ejemplo 4" />
        </td>
