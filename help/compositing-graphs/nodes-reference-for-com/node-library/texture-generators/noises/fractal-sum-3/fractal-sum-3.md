...
breadcrumb-title: ""
description: Utilice el nodo Suma fractal 3 para generar ruido fractal con tres octavas para crear patrones de textura orgánicos.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fractal-sum-3.resources/fractal_sum_3_1.png" class="modal-image" alt="Suma fractal 3 - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="fractal-sum-3.resources/noise_fractal_sum_3_v2_speed0.6_aniso0.gif" class="modal-image" alt="Suma fractal 3 - Ejemplo 2" />
        </td>
