...
breadcrumb-title: ''
description: Utilice el nodo Mapa de Suciedades 002 para generar patrones de suciedades de procedimiento para crear superficies de materiales envejecidas y con intemperie.
...
* **Patrón de pincel**: *0.0 - 1.0* Agrega una máscara alrededor de los bordes para cuando se usa como pincel alfa.
