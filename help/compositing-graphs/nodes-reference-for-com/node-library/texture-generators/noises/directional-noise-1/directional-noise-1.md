---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/directional-noise-1.html"
breadcrumb-title: ''
description: Utilice el nodo Ruido direccional 1 para generar patrones de ruido direccional para crear variaciones de texturas anisotrópicas.
...
![Ruido direccional 1 - Icono](directional-noise-1.resources/directional_noise_1.png "Ruido direccional 1 - Icono"){width="200px"}
...
![Ruido direccional 1 - Ejemplo 1](directional-noise-1.resources/directional_noise_1_1.png "Ruido direccional 1 - Ejemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Ruido direccional 1 - Ejemplo 2](directional-noise-1.resources/noise_directional_noise_1_v2_speed0.6_aniso0.gif "Ruido direccional 1 - Ejemplo 2"){zoomable="yes"}
...
![Ruido direccional 1 - Ejemplo 3](directional-noise-1.resources/noise_directional_noise_1_v2_speed0.6_aniso1.gif "Ruido direccional 1 - Ejemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Ruido direccional 1 - Ejemplo 4](directional-noise-1.resources/noise_directional_noise_1_v2_speed0.3_aniso0.6.gif "Ruido direccional 1 - Ejemplo 4"){zoomable="yes"}
