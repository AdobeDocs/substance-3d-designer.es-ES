...
El nodo **3D Perlin Noise Fractal** genera un ruido *fractal* Perlin en el espacio 3D basado en la entrada **Position Map**.
...
* **Escala** *Flotante*\
  Controla la escala del ruido fractal de Perlin 3D.
* **Tamaño** *Float3*\
  Controla el tamaño del ruido fractal de Perlin 3D en los ejes **X**, **Y** y **Z**. Los valores no uniformes dan como resultado un efecto de *estiramiento o aplastamiento*.
* **Desplazamiento** *Flotador*\
  Aplica un desplazamiento a la *posición* del ruido fractal 3D Perlin en los ejes **X**, **Y** y **Z**.
* **Intensidad de Distorsión** *Float*\
  Controla la intensidad de un *efecto de deformación* aplicado al ruido fractal de Perlin 3D.
...
* **Opacidad global** *Float*\
  Controla el *intervalo* de los valores de ruido fractal de Perlin 3D *alrededor de* el valor **Línea de base**.
