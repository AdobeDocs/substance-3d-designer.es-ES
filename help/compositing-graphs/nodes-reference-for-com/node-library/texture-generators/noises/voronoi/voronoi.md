...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant2.jpg" class="modal-image" alt="Voronoi - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant3.jpg" class="modal-image" alt="Voronoi - Ejemplo 2" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant5.jpg" class="modal-image" alt="Voronoi - Ejemplo 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant.jpg" class="modal-image" alt="Voronoi - Ejemplo 4" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant4.jpg" class="modal-image" alt="Voronoi - Ejemplo 5" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant6.jpg" class="modal-image" alt="Voronoi - Ejemplo 6" />
        </td>
    </tr>
</table>
