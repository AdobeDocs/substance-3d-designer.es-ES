---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-2.html"
breadcrumb-title: ''
description: Utilice el nodo Dirt 2 para generar patrones de dirt básicos para crear detalles de superficie intemperizados y efectos de acumulación.
...
![Dirt 2 - Icono](dirt-2.resources/dirt_2.png "Dirt 2 - Icono"){width="200px"}
...
![Dirt 2 - Ejemplo 1](dirt-2.resources/dirt_2_1.png "Dirt 2 - Ejemplo 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 2 - Ejemplo 2](dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso0.gif "Dirt 2 - Ejemplo 2"){zoomable="yes"}
...
![Dirt 2 - Ejemplo 3](dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso1.gif "Dirt 2 - Ejemplo 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 2 - Ejemplo 4](dirt-2.resources/noise_dirt_2_v2_speed0.3_aniso0.6.gif "Dirt 2 - Ejemplo 4"){zoomable="yes"}
