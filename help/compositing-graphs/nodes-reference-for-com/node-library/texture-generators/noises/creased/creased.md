...
Este nodo genera un ruido parecido al de una tela. Se puede interpretar como mapa de altura
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="creased.resources/creased-ex.gif" class="modal-image" alt="Arrugado - Ejemplo 1" />
        </td>
