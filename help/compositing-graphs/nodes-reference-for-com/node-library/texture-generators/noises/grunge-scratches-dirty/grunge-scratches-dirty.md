...
El nodo **Scratches de Suciedades sucios** genera un mapa de suciedades similar a una superficie sucia muy rayada.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-scratches-dirty.resources/grungescratchesdirty-variant2.jpg" class="modal-image" alt="Scratches de suciedad sucios - Ejemplo 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-scratches-dirty.resources/grungescratchesdirty-variant.jpg" class="modal-image" alt="Scratches de suciedad sucios - Ejemplo 2" />
        </td>
