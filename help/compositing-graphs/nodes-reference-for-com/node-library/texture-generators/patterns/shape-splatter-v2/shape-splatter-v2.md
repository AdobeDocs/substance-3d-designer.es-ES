...
| <b>Entrada de patrón 1</b> *Escala de grises* | La asignación de height para el patrón #1 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 2</b> *Escala de grises* | La asignación de height para el patrón #2 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 3</b> *Escala de grises* | La asignación de height para el patrón #3 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 4</b> *Escala de grises* | La asignación de height para el patrón #4 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 5</b> *Escala de grises* | La asignación de height para el patrón #5 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 6</b> *Escala de grises* | La asignación de height para el patrón #6 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 7</b> *Escala de grises* | La asignación de height para el patrón #7 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
| <b>Entrada de patrón 8</b> *Escala de grises* | La asignación de height para el patrón #8 que está disperso cuando <b>Tipo de patrón</b> está establecido en &#39;Entrada de patrón&#39;.<br><br><i>Sugerencia:</i> Utilice una resolución que esté cerca del tamaño máximo que puede tener el patrón cuando está disperso. |
...
|                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:-----------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Height</b> | El mapa de height calculado para las formas dispersas, incluido el height de fondo, si se utiliza y está visible. |
...
| <b>Función Position</b> *Float2* | Gráfico de funciones utilizado para definir la distribución de las formas.<br><br>El gráfico genera un valor Float2 para la posición normalizada XY de las formas de la imagen.<br><br>Variables disponibles:<br> - <code>shape.id</code> (Float) Identificador único de la forma.<br> - <code>shape.amount</code> (Float) Cantidad de formas especificada por el parámetro <b>Amount</b>. |
...
| <b>Formato normal de salida</b> *Entero* | Formato del mapa normal de salida.<br><br>Invierte de forma efectiva el canal verde.<br><br>- <b>DirectX:</b> El eje Y señala hacia arriba.<br>- <b>OpenGL:</b> El eje Y señala hacia abajo. |
...
| <b>Opacidad de entrada en segundo plano</b> *Flotador* | Intensidad de la entrada de <b>height de fondo</b> proporcionada en el mapa de height final.<br><br>Los heightes de las formas y el fondo se combinan usando una &#39;fusión máxima&#39;, donde se usa la más alta de las dos. |
