...
breadcrumb-title: ''
description: Utilice el nodo Fusión de Height de material para fusionar varios materiales en función de los mapas de altura para crear efectos de material en capas.
