...
### ![(error)](../../assets/error.svg) La función del parámetro *[x]* tiene algunas advertencias
...
![Solucionar error &#39;La función de parámetro tiene algunas advertencias&#39; advertencia](../../assets/warnings-comp-param-function.gif "Solucionar error &#39;La función de parámetro tiene algunas advertencias&#39; advertencia")
...
![Solucionar error &#39;Los datos de referencia tienen algunas advertencias&#39; advertencia](../../assets/warnings-comp-referenced-data.gif "Solucionar error &#39;Los datos de referencia tienen algunas advertencias&#39; advertencia")
...
### ![(error)](../../assets/error.svg) El nodo de texto usa una fuente no válida
