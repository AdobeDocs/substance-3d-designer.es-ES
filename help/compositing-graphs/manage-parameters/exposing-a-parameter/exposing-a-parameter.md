...
![Recorrido del método de exposición única](exposing-a-parameter.resources/exposing-a-parameter-02.gif "Recorrido del método de exposición única"){width="512px"}
...
1. Haga clic en el botón de opciones desplegables ![](exposing-a-parameter.resources/exposing-a-parameter-03.png)
1. Elija ![](exposing-a-parameter.resources/exposing-a-parameter-04.png) <b>Exponer como nueva entrada de gráfico</b> en la lista desplegable, la primera opción.
...
1. El nombre del parámetro se vuelve *azul* y ![](exposing-a-parameter.resources/exposing-a-parameter-05.png)\
...
![Recorrido del método de exposición por lotes](exposing-a-parameter.resources/exposing-a-parameter-06.gif "Recorrido del método de exposición por lotes"){width="512px"}
...
1. En lugar de encontrar un solo parámetro, busca el botón ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) <b>Exposición múltiple</b> en la parte superior derecha de la pestaña <b>Parámetros específicos</b>
...
1. Haga clic en <b>Aceptar</b> para confirmar y mostrar todos los parámetros seleccionados. Los nombres de los parámetros ahora muestran *blue* para confirmar que se exponen los parámetros, así como un botón ![](exposing-a-parameter.resources/exposing-a-parameter-05.png) <b>Editar función</b>.
...
1. Haga clic en el botón de opciones desplegables ![](exposing-a-parameter.resources/exposing-a-parameter-03.png) junto al parámetro que ya se ha expuesto
1. Elija ![](exposing-a-parameter.resources/exposing-a-parameter-04.png)<b> Editar entrada de gráfico expuesta</b>. Esto le llevará directamente a la entrada correspondiente en las propiedades del gráfico
...
![Parámetros de entrada](exposing-a-parameter.resources/exposing-a-parameter-08.png "Parámetros de entrada"){width="512px"}
...
![Editor de lista desplegable para parámetro entero](exposing-a-parameter.resources/exposing-a-parameter-09.gif "Editor de lista desplegable para parámetro entero"){width="512px"}
...
![Reordenar parámetros de entrada](exposing-a-parameter.resources/exposing-a-parameter-10.gif "Reordenar parámetros de entrada"){width="512px"}
...
![Previsualización de parámetros de entrada](exposing-a-parameter.resources/exposing-a-parameter-11.gif "Previsualización de parámetros de entrada"){width="512px"}
...
![Copiando y pegando parámetros de entrada](exposing-a-parameter.resources/exposing-a-parameter-12.gif "Copiando y pegando parámetros de entrada"){width="512px"}

### COPIAR Y PEGAR PARÁMETROS

Los parámetros se pueden copiar y pegar entre gráficos.

Se puede copiar un solo parámetro con el botón Copiar ![](exposing-a-parameter.resources/exposing-a-parameter-13.png). Se pueden copiar varios parámetros a través del menú Parámetros ![](exposing-a-parameter.resources/exposing-a-parameter-07.png). Seleccione Copiar entradas para copiar todas las entradas.

Elija Pegar entradas ![](exposing-a-parameter.resources/exposing-a-parameter-14.png) en el menú Parámetros ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) para pegar uno o más parámetros.
...
![Errores en parámetros de nodo](exposing-a-parameter.resources/exposing-a-parameter-15.gif "Errores en parámetros de nodo"){width="512px"}

### SEGUIMIENTO DE PARÁMETROS ROTOS EN NODOS

Puede hacer un seguimiento del parámetro que utiliza cada nodo a través de la herramienta Buscador de nodos ![](exposing-a-parameter.resources/exposing-a-parameter-16.png), que se encuentra en la barra superior de la vista de gráficos. Haga clic en él y le permitirá encontrar nodos utilizando parámetros específicos.

Si un nodo tiene un problema real, mostrará un distintivo de advertencia ![](exposing-a-parameter.resources/exposing-a-parameter-17.png) en su esquina superior izquierda. Al pasar el ratón sobre la insignia, se mostrará información sobre herramientas con más información.

Para restablecer y quitar un problema, para el parámetro que desea corregir o restablecer, haga clic en el botón desplegable ![](exposing-a-parameter.resources/exposing-a-parameter-03.png) situado junto al botón Editar función y seleccione ![](exposing-a-parameter.resources/exposing-a-parameter-18.png) <b>Restablecer. </b>Esto devuelve un parámetro a su estado anterior, no expuesto, el nombre azul se volverá gris de nuevo para reflejarlo.

![Limpiando parámetros de entrada no utilizados](exposing-a-parameter.resources/exposing-a-parameter-19.gif "Limpiando parámetros de entrada no utilizados"){width="512px"}

### LIMPIEZA DE PARÁMETROS DE ENTRADA NO UTILIZADOS

Si ha perdido la pista de los parámetros de entrada y ya no sabe cuáles se utilizan, se pueden limpiar con una pequeña herramienta. Haga clic en el botón de menú Parámetro de entrada ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) y seleccione <b>Limpiar entradas.</b>
