...
![Visualización simplificada de parámetros](../../../assets/parameters-5.png "Visualización simplificada de parámetros")
...
+++¿Qué es un parámetro?
*Un parámetro es un valor simple, con un elemento de interfaz de usuario, que controla el comportamiento de un gráfico.* Los usas constantemente en todo el software de Substance: para cambiar un color, definir el modo de fusión, elegir un valor de opacidad, etc... Sin parámetros, el software Substance no permitiría ninguna personalización.
...
![Recorrido del método de exposición única](../../../assets/single-expose2.gif "Recorrido del método de exposición única"){width="512px"}
...
1. El nombre del parámetro se vuelve *azul* y ![](../../../assets/image2020-9-17-15-35-46.png)\
...
1. En lugar de encontrar un solo parámetro, busca el botón ![](../../../assets/image2020-9-17-15-39-7.png) <b>Exposición múltiple</b> en la parte superior derecha de la pestaña <b>Parámetros específicos</b>
...
1. Haga clic en <b>Aceptar</b> para confirmar y mostrar todos los parámetros seleccionados. Los nombres de los parámetros ahora muestran *blue* para confirmar que se exponen los parámetros, así como un botón ![](../../../assets/image2020-9-17-15-35-46.png) <b>Editar función</b>.
...
1. Haga clic en el botón de opciones desplegables ![](../../../assets/image2020-9-17-15-35-59.png) junto al parámetro que ya se ha expuesto
1. Elija ![](../../../assets/image2020-9-17-15-37-7.png)<b> Editar entrada de gráfico expuesta</b>. Esto le llevará directamente a la entrada correspondiente en las propiedades del gráfico
...
![Parámetros de entrada](../../../assets/input-parameters-2.png "Parámetros de entrada"){width="512px"}
...
![Editor de lista desplegable para parámetro entero](../../../assets/dropdown.gif "Editor de lista desplegable para parámetro entero"){width="512px"}
...
![Reordenar parámetros de entrada](../../../assets/reorder-2.gif "Reordenar parámetros de entrada"){width="512px"}
...
![Previsualización de parámetros de entrada](../../../assets/parameter-preview-2.gif "Previsualización de parámetros de entrada"){width="512px"}
...
Se puede copiar un solo parámetro con el botón Copiar ![](../../../assets/image2019-9-19-11-3-49.png). Se pueden copiar varios parámetros a través del menú Parámetros ![](../../../assets/image2020-9-17-15-39-7.png). Seleccione Copiar entradas para copiar todas las entradas.

Elija Pegar entradas ![](../../../assets/image2020-9-17-16-43-15.png) en el menú Parámetros ![](../../../assets/image2020-9-17-15-39-7.png) para pegar uno o más parámetros.
...
![Errores en parámetros de nodo](../../../assets/parameter-error.gif "Errores en parámetros de nodo"){width="512px"}

### SEGUIMIENTO DE PARÁMETROS ROTOS EN NODOS

Puede hacer un seguimiento del parámetro que utiliza cada nodo a través de la herramienta Buscador de nodos ![](../../../assets/image2019-9-19-14-15-53.png), que se encuentra en la barra superior de la vista de gráficos. Haga clic en él y le permitirá encontrar nodos utilizando parámetros específicos.

Si un nodo tiene un problema real, mostrará un distintivo de advertencia ![](../../../assets/image2019-9-19-14-23-54.png) en su esquina superior izquierda. Al pasar el ratón sobre la insignia, se mostrará información sobre herramientas con más información.

Para restablecer y quitar un problema, para el parámetro que desea corregir o restablecer, haga clic en el botón desplegable ![](../../../assets/image2020-9-17-15-35-59.png) situado junto al botón Editar función y seleccione ![](../../../assets/image2020-9-17-16-56-18.png) <b>Restablecer. </b>Esto devuelve un parámetro a su estado anterior, no expuesto, el nombre azul se volverá gris de nuevo para reflejarlo.

![Limpiando parámetros de entrada no utilizados](../../../assets/clean-inputs-2.gif "Limpiando parámetros de entrada no utilizados"){width="512px"}

### LIMPIEZA DE PARÁMETROS DE ENTRADA NO UTILIZADOS

Si ha perdido la pista de los parámetros de entrada y ya no sabe cuáles se utilizan, se pueden limpiar con una pequeña herramienta. Haga clic en el botón de menú Parámetro de entrada ![](../../../assets/image2020-9-17-15-39-7.png) y seleccione <b>Limpiar entradas.</b>
