...
1. Haga clic en un nombre de parámetro en la columna <b>identificador de entrada de gráficos</b> de la lista para cambiar su nombre.
...
1. Use los cuadros de tipo <b>identificador de entrada de gráficos</b> y <b>Grupo de entrada de gráficos</b> de la parte inferior para agregar prefijos, sufijos y grupos de entrada a todos los parámetros expuestos a la vez. Todos estos valores se aplican sobre la configuración por parámetro.
