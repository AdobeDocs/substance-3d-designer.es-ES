...
| **Materiales de autor** | Sí | Sí | Sí |
| **Crear modelos 3D** | No | Limitada\* | Limitada\* |
| **Crea filtros, patrones y efectos** | No | Limitado | Sí |
| **Exportar contenido paramétrico** | No | No | Sí |
...
Le permite crear contenido para casi cualquier caso de uso o escenario. Esto significa que no está limitado a un solo tipo de salida, como un material único/conjunto de texturas para una malla mapeada por UV, sino que puede crear contenido para un conjunto mucho más amplio de usos.
...
**[No lineal](../../compositing-graphs/substance-compositing-graphs.md):** puede crear una multitud de salidas de textura a la vez. Edite una máscara o un regulador y se volverá a calcular automáticamente cualquier salida conectada. Ya no es necesario crear por separado mapas como color base, rugosidad, normal, etc.
