...
## Configuración del sistema por plataforma
...
| **GPU** | NVIDIA GeForce RTX 2060 Super<br>NVIDIA Quadro RTX 4000<br>AMD Radeon RX 5700 XT<br>AMD Radeon Pro W5700 | NVIDIA GeForce RTX 3080<br>NVIDIA Quadro RTX A4000<br>AMD Radeon RX 6800 XT<br>AMD Radeon Pro W7700 | NVIDIA GeForce RTX 4090<br>Generación NVIDIA Quadro RTX 5000 Ada<br>AMD Radeon RX 7900 XTX<br>AMD Radeon Pro W7800 |
...
* *Solo se han notarizado* versiones **2019.x** y superiores para poder ejecutarse en **macOS 10.15 Catalina**.
* **Es posible establecer una conexión de Escritorio remoto** si hay disponible un contexto de OpenGL 3.3. Funcionará en **Nvidia Quadro**, pero *no* en Nvidia GeForce porque solo proporciona un contexto OpenGL 1.4. Si esto es un problema, recomendamos usar soluciones alternativas como **VNC/Teamviewer**.
* Los usuarios de la versión **Steam** deben *deshabilitar* la **superposición de Steam** para Designer, ya que puede causar problemas de rendimiento cuando está activa.
...
* No se admite el uso de Designer en combinación con software de terceros que intercepte llamadas de Designer a los controladores gráficos. Dicho software incluye:
  * Inyectores de proceso posterior como resombreadores que aplican gradación de color, efectos de cámara, ...
...
| **Linux** | 535.129.03 | Radeon 23.20 Pro 23.Q3 | No admitido |

>[!NOTE]
>
> En **macOS**, el sistema operativo proporciona el controlador de la GPU. Actualice a la versión más reciente del sistema operativo para acceder al controlador más reciente.
