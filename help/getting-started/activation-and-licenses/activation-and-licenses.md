...
* <b>Activar usando tu cuenta</b>: Las cuentas de sustancias heredadas ya no se pueden utilizar para la activación. [Aquí encontrará más información sobre las cuentas de Substance](https://helpx.adobe.com/substance-3d/unlisted/faq-end-of-life-accounts.html).

>[!IMPORTANT]
>
> Para instalar el archivo de licencia con el Asistente para la activación, asegúrese de ejecutar Designer como administrador y desactive temporalmente el antivirus.
