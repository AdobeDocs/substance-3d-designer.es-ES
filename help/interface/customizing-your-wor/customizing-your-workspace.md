...
Para mostrar u ocultar un elemento de interfaz específico, haga clic en su nombre en el menú *Windows*. Los elementos mostrados tienen una marca de verificación ![](customizing-your-workspace.resources/image2015-12-17-10-43-24.png).
...
![Menú Windows](customizing-your-workspace.resources/windows-menu-1.png "Menú Windows")
...
![Redimensionando muelles](customizing-your-workspace.resources/interface-customisation-resize.gif "Redimensionando muelles")
...
![Muelles móviles](customizing-your-workspace.resources/interface-customisation-move.gif "Muelles móviles")
...
![Muelles de tabulación](customizing-your-workspace.resources/interface-customisation-tab.gif "Muelles de tabulación")
...
* Mueve el dock usando su *barra de título* y colócalo *fuera de la ventana principal* o en un área de la ventana principal que *no es un dock*. Puede volver a acoplar este conjunto acoplado moviéndolo en otro conjunto acoplado *en la ventana principal* o haciendo clic en el botón <b>![](customizing-your-workspace.resources/dock-icons-redock.png) Volver a acoplar </b>;
* Haciendo clic en el botón <b>![](customizing-your-workspace.resources/dock-icons-undock.png) Desacoplar</b>. Un dock desacoplado con este método puede *solo* reacoplarse haciendo clic en el botón <b>![](customizing-your-workspace.resources/dock-icons-redock.png) Reacoplar</b>.

![Desacoplando](customizing-your-workspace.resources/interface-customisation-undock.gif "Desacoplando")
...
* Haciendo clic en el botón <b>![](customizing-your-workspace.resources/dock-icons-maximise.png) Maximizar</b>
...
* Colocando el *cursor sobre el muelle* y presionando la tecla <b>Mayús+Espacio</b>
* Haciendo clic en el botón <b>![](customizing-your-workspace.resources/dock-icons-minimise.png) Minimizar</b>
...
![Maximización de muelles](customizing-your-workspace.resources/interface-customisation-maximise.gif "Maximización de muelles")
...
Para fijar un conjunto acoplado, haga clic en su botón ![](customizing-your-workspace.resources/dock-icons-pin.png) <b>Fijar</b>. A continuación, puedes *desanclarlo* con el botón ![](customizing-your-workspace.resources/dock-icons-pinned.png) <b>Desanclar</b> para que *esté disponible* de nuevo para alojar cualquier contenido nuevo.
...
![Muelles de fijación](customizing-your-workspace.resources/interface-customisation-pin.gif "Muelles de fijación")

## Cerrando muelles

Se puede cerrar cualquier estación de acoplamiento haciendo clic en su botón ![](customizing-your-workspace.resources/dock-icons-close.png) <b>Cerrar</b>.
...
![Restablecer diseño](customizing-your-workspace.resources/interface-customisation-reset.gif "Restablecer diseño")
