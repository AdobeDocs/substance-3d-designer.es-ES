---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/interface/preferences-window/project-settings.html"
breadcrumb-title: ''
...
![Configuración del proyecto](../../../assets/2019-3-0-prefs-proj-01.png "Configuración del proyecto"){zoomable="yes"}
...
|                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Plantillas de Substance</b> | Al crear un nuevo gráfico, se le pide que empiece a trabajar con una **plantilla** que puede tener una serie de configuraciones y contenido *preconfigurados*, como salidas (p. ej. *PBR (Metallic/Roughness)*). Esta configuración le permite dirigir Designer a directorios en los que puede almacenar sus propios archivos SBS para utilizarlos como plantillas. Las plantillas personalizadas se *agregarán a la lista* al crear un nuevo gráfico <br><br>*Valor predeterminado: Ninguno *<br><br>*Nota:* Se recomienda utilizar las plantillas actuales como referencia para configurar y dar formato a los archivos de SBS de plantillas.  Las plantillas se encuentran en la carpeta **resources > templates** del directorio de instalación de Substance 3D Designer. |
| <b>Escenas 3D</b> | De forma predeterminada, Designer usa el **espacio de tangente MikkT** en la Vista 3D. MikkT se usa mucho y es el valor predeterminado en programas como Unity, Unreal Engine 4, Blender y xNormal. Puede usar **su propio espacio tangente** para el Vista 3D, que se proporciona a Designer en forma de una entrada de *archivo DLL* en esta configuración. La etiqueta se detecta automáticamente a partir del archivo DLL y puede editar la descripción del complemento <br><br>*Default: mikktspace.dll* Volver a calcular siempre los marcos de tangentes <br><br>*Valor predeterminado: Desmarcado*&#x200B;Ángulo de suavizado normal y tangente <br><br>*Valor predeterminado: 180,0°* |
| <b>Misc</b> | Los mapas de normales se pueden generar o procesar usando el formato <b>DirectX</b> o <b>OpenGL</b>. Esta configuración establece el valor de este formato en varios lugares, como [propiedades de material](../../../interface/3d-view/material-properties/material-properties.md) en los parámetros de nodo de filtro [Vista 3D](../../../interface/3d-view/3d-view.md) y [Normal](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md).<br><br>*Valor predeterminado: DirectX*<br><br> Con respecto al nodo de filtro [Normal](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md), puedes establecer el valor predeterminado para el parámetro <b>Contenido de canal alfa</b>. Puede elegir forzar el valor alfa a 1 en todos los casos o rellenarlo con información de su entrada.<br><br>*Valor predeterminado: Forzar el Alpha a 1* |
...
Si SBS paquetes se agregan a la biblioteca, los **gráficos** y **recursos** que contiene se pueden *mostrar en la biblioteca* como entradas independientes, si su parámetro **Visible en biblioteca** está establecido en &#39;Sí&#39;.\
...
Si un documento de [Photoshop](https://www.adobe.com/es/products/photoshop.html) (\*.PSD file) incluido en la biblioteca tiene <b>varias capas</b>, una opción te permite mostrar el contenido de* cada capa como una entrada de imagen independiente* en la biblioteca.
