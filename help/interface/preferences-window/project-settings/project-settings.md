...
| <b>Estado de iluminación predeterminado</b> | Esta configuración le permite seleccionar cuál de las luces disponibles predefinidas debe habilitarse al iniciar una nueva [vista 3D](../../../interface/3d-view/3d-view.md), *si no hay ningún archivo establecido* en el campo **Archivo de estado predeterminado**<br><br>*Valor predeterminado: Solo luz ambiente* |
...
> Consulte la sección [Administración de contenido y filtros personalizados](https://helpx.adobe.com/es/substance-3d/unlisted/documentation/sddoc/creating-library-filters-for-projects-170459772.html) de la documentación para obtener más información.
