...
![Información del área de trabajo P4V](version-control.resources/p4v-workspace-strings.jpg "Información del área de trabajo P4V"){zoomable="yes"}
...
Ficha ![&#39;Control de versiones&#39; en la configuración del proyecto](version-control.resources/p4v-project-settings.jpg "&#39;Ficha Control de versiones&#39; en la configuración del proyecto"){zoomable="yes"}
...
Configuración de ![P4 en Designer: área de trabajo](version-control.resources/p4v-project-settings-workspace.jpg "configuración P4 en Designer: área de trabajo"){zoomable="yes"}
...
Configuración de ![P4 en Designer: acciones](version-control.resources/p4v-project-settings-actions.jpg "Configuración de P4 en Designer: acciones"){zoomable="yes"}
...
Configuración de ![P4 en Designer: intérprete](version-control.resources/p4v-project-settings-interpreters.jpg "Configuración de P4 en Designer: intérprete"){zoomable="yes"}
...
1. Hay varias acciones disponibles, en función del estado del archivo del paquete en el espacio de trabajo:
   ...
   * <b>Actualizar estado:</b> Actualizar el estado del archivo del paquete
   ...
   Cuadro de diálogo ![&#39;Enviar&#39;](version-control.resources/p4v-submit.jpg "&#39;Enviar&#39;"){zoomable="yes"}

   </td>
   <td style="border: 0;" valign="top">

   Cuadro de diálogo ![&#39;Revertir&#39;](version-control.resources/p4v-revert.jpg "&#39;Revertir&#39;"){zoomable="yes"}
...
![Icono de paquete: Actualizado](version-control.resources/p4-up-to-date.png "Icono de paquete: Actualizado")
...
![Icono de paquete: Retirado](version-control.resources/p4-checked-out.png "Icono de paquete: Desprotegido")
...
![Icono de paquete: Añadido](version-control.resources/p4-added.png "icono de paquete: Agregado")
...
![Icono de paquete: No está en depósito](version-control.resources/p4-not-in-depot.png "Icono de paquete: No está en el almacén")
