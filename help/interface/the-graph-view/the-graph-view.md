...
<b>pin de navegación</b> permiten ir rápidamente a puntos de interés del gráfico.
...
<b>Agregar marco:</b> Agregar un objeto gráfico [Marco](../../interface/the-graph-view/graph-items/graph-items.md);
...
<b>Ver salida en Vista 2D:</b> Mostrar una de las salidas del gráfico en [Vista 2D](../../interface/2d-view/2d-view.md); consulte [Interacción con el Vista 2D](#interacting-with-the-2d-view) a continuación;
...
<b>pin anterior:</b> Vaya al objeto [Pin](../../interface/the-graph-view/graph-items/graph-items.md) anterior en el gráfico;

<b>Siguiente pin:</b> Desplácese al siguiente objeto [Pin](../../interface/the-graph-view/graph-items/graph-items.md) del gráfico;
...
*- Exportador de PSD:* Abre la interfaz de [Exportador de PSD](../../compositing-graphs/exporting-psd-files/exporting-psd-files.md).
...
Los tamaños horizontal y vertical están vinculados de forma predeterminada, pero se pueden *desvincular* para las texturas que no sean cuadradas. Los valores también se pueden restablecer al valor predeterminado de 256 x 256.
