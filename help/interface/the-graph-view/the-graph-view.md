...
![Navegación por ventanilla](the-graph-view.resources/the-graph-view-01.gif "Navegación por ventanilla")
...
![Colocando nodos](the-graph-view.resources/the-graph-view-02.gif "Colocando nodos")
...
![Vista de gráfico: Menú de nodos](the-graph-view.resources/the-graph-view-03.png "Vista de gráficos: Menú Nodo")
...
![Seleccionando nodos](the-graph-view.resources/the-graph-view-04.gif "Seleccionando nodos")
...
![Nodos de conexión](the-graph-view.resources/the-graph-view-05.gif "Nodos de conexión")
...
* Se muestran con la insignia ![](the-graph-view.resources/the-graph-view-06.png) <b>Deshabilitado</b>*,* un *contorno discontinuo* y un vínculo interior *que redirecciona* en lugar de una miniatura;
...
![Deshabilitando nodos](the-graph-view.resources/the-graph-view-07.gif "Deshabilitando nodos"){width="512px"}

## Interacción con el Vista 2D
...
![](the-graph-view.resources/the-graph-view-08.png) <b>Selección de enfoque</b> (F)\
Centrar la vista en la selección o en toda la escena si la selección está vacía.

![](the-graph-view.resources/the-graph-view-09.png) <b>Restablecer zoom</b> (Z)\
...
![](the-graph-view.resources/the-graph-view-10.png) <b>Exportar vista de gráfico\
...
![](the-graph-view.resources/the-graph-view-11.png) <b>Información del nodo\
...
Buscador de nodos ![](the-graph-view.resources/the-graph-view-12.png)<b></b> (Ctrl+F)\
...
![](the-graph-view.resources/the-graph-view-13.png) <b>Resaltar flujo\
...
![](the-graph-view.resources/the-graph-view-14.png) <b>Paleta de nodos\
</b>Muestra u oculta la barra de herramientas del nodo, consulte a continuación.

![](the-graph-view.resources/the-graph-view-15.png) <b>Vínculos de rectángulo\
...
![](the-graph-view.resources/the-graph-view-16.png) <b>Herramientas de alineación de nodos\
...
![](the-graph-view.resources/the-graph-view-17.png) <b>Tamaño primario\
</b>Alterna la presentación de la configuración del control de resolución principal, consulte a continuación.

![](the-graph-view.resources/the-graph-view-18.png) <b>Modos de creación de vínculos</b> (1, 2, 3)\
...
Control <b>Timings de ![](the-graph-view.resources/the-graph-view-19.png)\
</b>Permite restablecer todos los nodos y todas las horas.

![](the-graph-view.resources/the-graph-view-20.png) <b>Herramientas\
...
![](the-graph-view.resources/the-graph-view-21.png) <b>Caché de imágenes de nodo\
</b>Alterna la visualización del conmutador de caché de imagen de nodo, consulte a continuación.

![](the-graph-view.resources/the-graph-view-22.jpg) Quitar nodos no utilizados\
...
[![Paleta de nodos](the-graph-view.resources/the-graph-view-23.png)](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/atomic-nodes.md)<br>
...
![Paleta de elementos de gráfico](the-graph-view.resources/the-graph-view-24.png "Paleta de elementos de gráfico")<br>
...
![Barra de herramientas Tamaño primario](the-graph-view.resources/the-graph-view-26.png "Barra de herramientas Tamaño primario")
...
![Configuración de caché de imágenes de nodo](the-graph-view.resources/the-graph-view-27.png "Configuración de caché de imágenes de nodo")
...
![Quitar nodos no utilizados del menú desplegable](the-graph-view.resources/the-graph-view-28.jpg "Quitar nodos no utilizados del menú desplegable")
...
La herramienta ![](the-graph-view.resources/the-graph-view-22.jpg) Quitar nodos no utilizados</b> elimina todos los nodos que *no* forman parte de una secuencia que *termina en un nodo de salida*. La única excepción son los *nodos de entrada*, ya que al eliminarlos se cambiaría la interfaz de los [nodos de instancia](../../compositing-graphs/creating-compositing-gra/graph-instances-sub-gra/graph-instances-sub-graphs.md) que hacen referencia a este gráfico.

![Quitar nodos no utilizados](the-graph-view.resources/the-graph-view-29.gif "Quitar nodos no utilizados")
