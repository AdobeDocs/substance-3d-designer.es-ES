...
![Icono de nodo de punto](dot-node.resources/dot-node-01.png "Icono de nodo de punto")
...
![Insertando un nodo de punto](dot-node.resources/dot-node-02.gif "Insertando un nodo de punto"){width="512px"}
...
![Punto: Creando desde el conector](dot-node.resources/dot-node-03.gif "Punto: Creando desde el conector")
...
![Nodo punto en el menú Nodo](dot-node.resources/dot-node-04.png "Nodo punto en el menú Nodo")
...
![Combinando vínculos](dot-node.resources/dot-node-05.gif "Combinando vínculos"){width="512px"}
...
![Nodo de punto como portal - icono](dot-node.resources/dot-node-06.png "Nodo de punto como portal - icono")
...
![Nodo de punto como portal](dot-node.resources/dot-node-07.gif "Nodo de punto como portal")
