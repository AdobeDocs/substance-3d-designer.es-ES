...
![Barra de herramientas del Buscador de nodos](node-finder.resources/node-finder-toolbar.png "Barra de herramientas del Buscador de nodos"){zoomable="yes"}
...
En la barra de herramientas Vista de gráficos, haga clic en el botón <b>Buscador de nodos ![](node-finder.resources/graph-node-finder.png)</b> para mostrar la barra de herramientas Buscador de nodos. Una vez mostrada, la barra de herramientas sólo se cierra al hacer clic en este botón.
...
![Buscador de nodos: recorrer gráficos durante la búsqueda](node-finder.resources/node-finder-traversal.gif "Buscador de nodos: recorrer gráficos durante la búsqueda"){zoomable="yes"}

### Consulta de búsqueda

![Campo de consulta del Buscador de nodos](node-finder.resources/node-finder-query-field.png "Campo de consulta del Buscador de nodos"){zoomable="yes"}
...
![Tipo de nodo](node-finder.resources/node-finder-node-types.png "Tipo de nodo"){zoomable="yes"}
...
![Tipos de nodo (composición)](node-finder.resources/node-finder-types-compositing.png "Tipos de nodo (composición)"){zoomable="yes"}



*Tipos de nodos para gráficos de composición*

![Tipos de nodo (función)](node-finder.resources/node-finder-types-function.png "Tipos de nodo (función)"){zoomable="yes"}
...
![Buscador de nodos: Buscando por tipo &#39;Niveles&#39; (composición)](node-finder.resources/node-finder-compositing-levels.png "Buscador de nodos: Buscando por tipo &#39;Niveles&#39; (composición)"){zoomable="yes"}
...
![Buscador de nodos: Buscando por tipo de &#39;instancia&#39; (composición)](node-finder.resources/node-finder-compositing-instances.png "Buscador de nodos: Buscando por tipo de &#39;instancia&#39; (composición)"){zoomable="yes"}



*Buscando el tipo de nodo &#39;Instance&#39; en un gráfico de Substance*

![Buscador de nodos: Buscando por tipo de &#39;instancia&#39; (función)](node-finder.resources/node-finder-functions-instances.png "Buscador de nodos: Buscando por tipo de &#39;instancia&#39; (función)"){zoomable="yes"}
...
El botón <b>Opciones de búsqueda ![](node-finder.resources/node-finder-search-options.png)</b> abre una lista de configuraciones usadas para la búsqueda que se pueden activar y desactivar.
...
![Opciones de búsqueda del Buscador de nodos](node-finder.resources/node-finder-search-options-open.png "Opciones de búsqueda del Buscador de nodos"){zoomable="yes"}
...
![Buscador de nodos: buscando por identificador de gráfico](node-finder.resources/node-finder-functions-identifier.png "Buscador de nodos: buscando por identificador de gráfico"){zoomable="yes"}
...
![Explorador: contenido del paquete](node-finder.resources/explorer-package-simple.png "Explorador: contenido del paquete"){zoomable="yes"}
...
![Identificador de gráfico en la información sobre herramienta del nodo de instancia](node-finder.resources/node-finder-compositing-identifier.png "Identificador de gráfico en la información sobre herramienta del nodo de instancia"){zoomable="yes"}
...
![Buscador de nodos: Variables de nodo](node-finder.resources/node-finder-compositing-variable.png "Buscador de nodos: Variables de nodo"){zoomable="yes"}
...
![Sugerencias de consulta del buscador de nodos](node-finder.resources/node-finder-available-query-suggestions.png "Sugerencias de consulta del buscador de nodos"){zoomable="yes"}
...
![Buscador de nodos: parámetros expuestos](node-finder.resources/node-finder-compositing-exposed-parameter.png "Buscador de nodos: parámetros expuestos"){zoomable="yes"}
...
![Buscador de nodos: buscando la variable de la consola advertencia/error](node-finder.resources/node-finder-console-identifier.png "Buscador de nodos: buscando variable de advertencia/error de consola"){zoomable="yes"}
...
![Buscador de nodos: Buscar una variable coincide Obtener nodos que la utilicen](node-finder.resources/node-finder-exposed-parameter-01.gif "Buscador de nodos: Buscar coincidencias de una variable Obtener nodos que la usen"){zoomable="yes"}
...
![Buscador de nodos: buscar por UID](node-finder.resources/node-finder-compositing-uid-search.png "Buscador de nodos: buscar por UID"){zoomable="yes"}
...
![Buscador de nodos: copiar acción de UID de nodo](node-finder.resources/node-finder-compositing-uid-copy.png "Buscador de nodos: acción de UID de copiar nodo"){zoomable="yes"}
...
![Buscador de nodos: Buscando UID de nodo desde la consola](node-finder.resources/node-finder-console-uid.png "Buscador de nodos: Buscando UID de nodo desde la consola"){zoomable="yes"}
...
El botón <b>Opciones de búsqueda ![](node-finder.resources/node-finder-search-options.png)</b> le permite alternar los modos <b>recursivo</b> y <b>difuso</b> para buscar nodos.
...
![Buscador de nodos: búsqueda recursiva](node-finder.resources/node-finder-recursion-01.png "Buscador de nodos: búsqueda recursiva"){zoomable="yes"}
...
+++Ejemplo 1
![Buscador de nodos: ejemplo de búsqueda recursiva 1](node-finder.resources/node-finder-recursion-01.gif "Buscador de nodos: ejemplo de búsqueda recursiva 1"){zoomable="yes"}
...
+++Ejemplo 2
![Buscador de nodos: ejemplo de búsqueda recursiva 2](node-finder.resources/node-finder-recursion-02.gif "Buscador de nodos: ejemplo de búsqueda recursiva 2"){zoomable="yes"}
...
![Buscador de nodos: Modo difuso](node-finder.resources/node-finder-functions-fuzzy.png "Buscador de nodos: Modo difuso"){zoomable="yes"}
