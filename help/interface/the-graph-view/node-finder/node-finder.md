...
![Buscador de nodos: buscando por identificador gráfico](node-finder.resources/node-finder-functions-identifier.png "Buscador de nodos: buscando por identificador de gráfico"){zoomable="yes"}
...
![Información sobre el identificador gráfico en el nodo de instancia](node-finder.resources/node-finder-compositing-identifier.png "Información sobre el identificador gráfico en el nodo de instancia"){zoomable="yes"}
