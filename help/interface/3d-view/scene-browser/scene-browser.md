...
Se muestra al hacer clic en su botón de alternancia dedicado ![](scene-browser.resources/scene-browser-01.png) en la [barra de herramientas de escena de vista 3D](../../../interface/3d-view/3d-view.md).

![Explorador de escenas: escena 3D cargada](scene-browser.resources/scene-browser-02.png "Explorador de escenas: escena 3D cargada"){zoomable="yes"}
...
![Explorador de escenas - Árbol de escenas](scene-browser.resources/scene-browser-03.png "Explorador de escenas - Árbol de escenas"){zoomable="yes"}
...
![Explorador de escenas: los objetos agregados por Designer aparecen en negrita](scene-browser.resources/scene-browser-04.png "Explorador de escenas: los objetos agregados por Designer aparecen en negrita"){zoomable="yes"}
...
La visibilidad de un objeto se puede alternar haciendo clic en su botón de ojo ![](scene-browser.resources/scene-browser-05.png) o desde su menú contextual. El menú ofrece algunas acciones más para administrar la visibilidad de los objetos de escena:
...
![Explorador de escenas: cambiar la visibilidad del objeto](scene-browser.resources/scene-browser-06.gif "Explorador de escenas: cambiar la visibilidad del objeto"){zoomable="yes"}
...
![Explorador de escenas: alternando la visibilidad del entorno](scene-browser.resources/scene-browser-07.gif "Explorador de escenas: alternando la visibilidad del entorno"){zoomable="yes"}

### Luces

Lo mismo ocurre con las luces de la escena: cada uno se puede alternar individualmente.

![Explorador de escenas: cambiar la visibilidad de la luz](scene-browser.resources/scene-browser-08.gif "Explorador de escenas: cambiar la visibilidad de la luz"){zoomable="yes"}
...
![Explorador de escenas: material conectado](scene-browser.resources/scene-browser-09.png "Explorador de escenas: material conectado"){zoomable="yes"}
