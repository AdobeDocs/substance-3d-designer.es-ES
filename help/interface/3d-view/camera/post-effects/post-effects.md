...
![Efectos posteriores](../../../../assets/postEffects.png "Efectos posteriores"){zoomable="yes"}

En las propiedades de la cámara, puede activar los efectos posteriores para mejorar los procesamientos o comprobar propiedades de material específicas.
