...
Después de configurar un material, una cámara, luces, etc. en la vista 3D, ese estado se puede guardar en un archivo de estado de escena (.sbsscn) que se puede cargar posteriormente para restaurar ese estado. Por ejemplo, puede configurar algunas escenas para previsualizar diferentes tipos de materiales o un entorno de iluminación específico.
