...
El sombreado de los objetos se basa en sus vectores normales, tangentes y binormales. Sus coordenadas utilizan el rango [-1, 1], mientras que los mapas de normales utilizan el rango [0, 1] en la mayoría de los casos. Para adaptar los valores de uno a otro, se debe aplicar un sesgo y una escala de <b>y</b>: valor\*escala+sesgo.
