...
Girar el espacio alrededor de un eje en un ángulo ajustable.<br>La posición del mundo transformada de salida se puede conectar a la entrada <b>P</b> de la mayoría de las Funciones SDF para definirlas en este espacio del mundo transformado.<br><br>Use el ayudante <b>Transformar tabla dinámica</b> del <b>Visor 3D</b> para visualizar la rotación realizada.<br><br><i>Sugerencia:</i> Las transformes P se pueden encadenar, pero tenga en cuenta que los resultados dependen del orden de las operaciones.
