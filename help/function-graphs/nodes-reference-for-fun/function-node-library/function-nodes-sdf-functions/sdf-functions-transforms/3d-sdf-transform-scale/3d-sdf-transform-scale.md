---
title: Escala
description: Designer > Gráficos de composición de Substance > Referencia de nodos para Substance > Biblioteca de nodos > Función SDF > Transformar > Escala
...
| <b>Escala</b> *Flotador* | Factor de escala uniforme.<br><br><i>Valor predeterminado: 1</i> |
| <b>Posición de pivote</b> *Float3* | Posición del espacio mundial del pivote local de la forma SDF, donde (0, 0, 0) coloca el pivote en el centro de la forma SDF. <br>Define el origen de la escala.<br><br><i>Valor predeterminado: (0, 0, 0)</i> |
