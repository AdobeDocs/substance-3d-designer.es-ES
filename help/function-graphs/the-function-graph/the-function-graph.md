...
![Gráfico de funciones de Substance](the-function-graph.resources/the-function-graph-01.png "Gráfico de funciones de Substance")
...
![lista de nodos del gráfico de funciones del Substance](the-function-graph.resources/the-function-graph-02.png "lista de nodos del gráfico de funciones del Substance")
...
![nodo de salida del gráfico de funciones de Substance](the-function-graph.resources/the-function-graph-03.png "nodo de salida del gráfico de funciones de Substance")
...
![Definiendo el nodo de salida](the-function-graph.resources/the-function-graph-04.gif "Definiendo el nodo de salida")
...
![Gráfico de funciones de Substance con referencia abierta](the-function-graph.resources/the-function-graph-05.png "Gráfico de funciones de Substance con referencia abierta")
...
![Eliminar gráfico de funciones del Substance del paquete](the-function-graph.resources/the-function-graph-06.gif "Eliminar gráfico de funciones del Substance del paquete")
