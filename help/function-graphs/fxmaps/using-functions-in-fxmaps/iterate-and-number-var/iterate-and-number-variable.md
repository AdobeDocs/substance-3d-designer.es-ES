...
Cuando se utiliza un nodo Iterate, se puede utilizar la variable $number para obtener el valor de iteración actual. $number es un valor flotante que comienza en 0.
