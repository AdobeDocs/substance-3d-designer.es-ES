...
![Material de Malaquita MDL](../assets/mdl-malachite-example.jpg "Material de Malaquita MDL")
...
¿Estás ansioso por saltar? Empieza a usar gráficos MDL en la sección [Recursos de aprendizaje MDL](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/first-steps-with-mdl-145654095.html).
...
*Propiedades de gráfico MDL en el panel [Propiedades](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/parameters-ui-129368153.html)*
...
En esta sección se enumeran los parámetros interactivos conectados a [parámetros expuestos](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/exposing-a-parameter-145654033.html) del gráfico MDL y se definen sus *valores predeterminados*. Se pueden *reorganizar* y *reordenar* en cualquier momento.
