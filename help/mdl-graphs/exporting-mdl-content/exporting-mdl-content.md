...
La exportación de un módulo MDL se realiza en el nivel de *paquete*. Para exportar un módulo MDL para un paquete determinado, haz clic en el botón ![](exporting-mdl-content.resources/exporting-mdl-content-01.png) <b>Exportar módulo MDL</b> del [Explorador](../../interface/the-explorer-window/the-explorer-window.md) o selecciona esa misma opción en el *menú contextual del paquete*. Seleccione una ubicación de destino y un nombre para el módulo MDL exportado. Se muestra el cuadro de diálogo <b>Informe de exportación</b> con la lista de mensajes registrados durante el proceso de exportación.
...
![Ruta de exportación MDL](exporting-mdl-content.resources/exporting-mdl-content-02.png "Ruta de exportación MDL")
...
* El panel [Explorador](../../interface/the-explorer-window/the-explorer-window.md), haciendo clic en <b>RMB</b> en el recurso de gráfico MDL y seleccionando el ajuste preestablecido <b>Exportar...Opción </b> en el menú contextual
...
El ajuste preestablecido exportado utilizará los *valores actuales* de los parámetros del material en la vista 3D como los *nuevos valores predeterminados*. Estos valores se pueden modificar mediante la opción <b>Materiales > mi\_material > Editar</b>, que mostrará los parámetros expuestos del material en el panel Propiedades.

>[!WARNING]
>
> Al exportar un módulo MDL desde el panel [Explorador](../../interface/the-explorer-window/the-explorer-window.md), se genera un módulo MDL que contiene *todos* los materiales MDL definidos por un gráfico MDL en el paquete; al exportar un ajuste preestablecido MDL desde [Vista 3D](../../interface/3d-view/3d-view.md), se genera un módulo MDL que contiene *solo* la definición de los materiales MDL aplicados al *material seleccionado* en el menú - `my_material` en este ejemplo.

![Ruta de exportación de ajustes preestablecidos de MDL](exporting-mdl-content.resources/exporting-mdl-content-03.png "Ruta de exportación de ajustes preestablecidos de MDL")
...
La exportación de un archivo de módulo MDL se realiza en el nivel de *paquete*. Para exportar un archivo de módulo MDL para un paquete determinado, haga clic en el botón ![](exporting-mdl-content.resources/exporting-mdl-content-01.png) <b>Exportar archivo de módulo MDL</b> en el [Explorador](../../interface/the-explorer-window/the-explorer-window.md) o seleccione esa misma opción en el *menú contextual del paquete*. Seleccione una ubicación de destino y un nombre para el archivo del módulo MDL exportado y se mostrará el cuadro de diálogo <b>Exportar informe</b> con la lista de mensajes registrados durante el proceso de exportación.
...
![Ruta de exportación MDR](exporting-mdl-content.resources/exporting-mdl-content-04.png "Ruta de exportación MDR")
...
![Ruta de exportación MDLE](exporting-mdl-content.resources/exporting-mdl-content-05.png "Ruta de exportación MDLE")
