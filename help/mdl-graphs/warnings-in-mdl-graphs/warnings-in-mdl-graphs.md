...
>[!NOTE]
>
> Las ilustraciones de esta sección se registraron en <b>Substance model graphs</b>, que se *retiraron* en la versión <b>13.0.0</b> de Substance 3D Designer. Sin embargo, también se aplican a los gráficos MDL.

## ![(error)](warnings-in-mdl-graphs.resources/error.svg) No se ha definido ningún nodo de salida

El gráfico no tiene definido ningún nodo de salida.

<b>![(tick)](warnings-in-mdl-graphs.resources/check.svg) Solución</b>
