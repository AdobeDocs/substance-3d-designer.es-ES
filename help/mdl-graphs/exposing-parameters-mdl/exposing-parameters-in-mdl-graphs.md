...
![Estado expuesto de las entradas de nodo](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-01.png "Estado expuesto de las entradas de nodo")
...
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-02.png)Copiar valor a un nuevo nodo y vincularlo a este parámetro**: crea un *conector de entrada* para esta propiedad y la conecta a un *nuevo nodo* que genera el valor actual de esta propiedad
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-03.png)Crear una ubicación de entrada para este parámetro**: crea un *conector de entrada* para esta propiedad
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-04.png)Restablezca este parámetro a su valor predeterminado**: cuando no hay ningún valor conectado al conector de entrada de esta propiedad, restablece su valor predeterminado
...
![Parámetros de nodo expuestos](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-06.png "Parámetros de nodo expuestos")
...
Opción &quot;Expose&quot; de ![ en el menú contextual de un nodo](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-07.png "&amp;quot;Expose&amp;quot; en el menú contextual de un nodo")
...
![Exponer nodos en entradas de gráficos](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-08.gif "Exponer nodos en entradas de gráficos")
