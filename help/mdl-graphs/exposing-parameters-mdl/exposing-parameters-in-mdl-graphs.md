...
* **![](exposing-parameters-in-mdl-graphs.resources/mdl-expose-new-input.png)Crear una ubicación de entrada para este parámetro**: crea un *conector de entrada* para esta propiedad
