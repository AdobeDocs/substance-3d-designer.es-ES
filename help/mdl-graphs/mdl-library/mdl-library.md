...
## Contenido MDL en el Vista 3D

Todos los módulos MDL disponibles en la biblioteca se pueden usar en el [Vista 3D](../../interface/3d-view/3d-view.md) cuando se usa el procesador de Iray.
