...
* **![](creating-an-mdl-graph.resources/creating-an-mdl-graph-05.png)Mostrar gráficos**: las plantillas se muestran por su *solo etiqueta*, en el orden de los archivos [Substance 3D](https://www.adobe.com/products/substance3d/3d-augmented-reality.html) del directorio de plantillas
