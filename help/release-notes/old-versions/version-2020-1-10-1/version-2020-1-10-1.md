---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/release-notes/old-versions/version-2020-1-10-1.html"
breadcrumb-title: ''
...
**Substance Designer 2020.1** incluye un nuevo editor de método abreviado, un complemento de MaterialX y muchas mejoras nuevas para la administración de color con funciones de Adobe Color Engine y bakeres nuevos.
...
### Nuevo Editor de Método abreviado para la Creación de Nodo

![](../../../assets/banner-shortcuts.png)

En esta versión presentamos un nuevo editor de método abreviado que permite definir atajos de teclado para acelerar la creación de nodos en los diferentes modos de gráfica.

Se puede acceder al nuevo editor de método abreviado en las preferencias principales a través de **Editar > Preferencias > Accesos directos**. De forma predeterminada, todos los campos de método abreviado están vacíos.
...
* **Creando un nuevo método abreviado**\
...
* Desarrolla sombreadores y texturas procedimientos en paralelo.
* Cree sombreadores avanzados para Substance Painter con funciones como mapas de detalle y máscaras procedimientas que se pueden cambiar en tiempo de ejecución.
* Combine las características del sombreador desde un motor de juegos o una canalización de efectos visuales en el puerto de visualización Substance Designer y Substance Painter.
...
Además de OpenColorIO ahora es posible utilizar el Adobe Color Engine (ACE) para admitir perfiles ICC en la gestión de color. Esto significa que ahora puede importar y exportar imágenes calibradas para que se correspondan con otro software, como Photoshop y Illustrator.
...
* **ACE para la administración de color heredada**\
  El transforme de salida ACE tonemapped ahora está disponible con el modo de administración de color heredado.
...
* **Nuevo filtro FXAA**\
  El nuevo filtro implementa el algoritmo de suavizado rápido aproximado (FXAA), que es un método de suavizado. Se puede utilizar en la textura normal para suavizar líneas o bordes irregulares.\
