...
* **Abre el menú al hacer clic y arrastrar un vínculo desde un nodo**\
  Al hacer clic y arrastrar la conexión de un nodo y soltar el ratón, se abrirá el menú Creación de nodos. El nodo creado se conectará al vínculo. Los nodos disponibles en la lista dependerán de la conexión entrante. ![](version-2019-2-9-2.resources/version-2019-2-9-2-05.gif)
