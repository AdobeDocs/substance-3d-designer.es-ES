...
**Substance Designer 2019.2** ofrece el nuevo nodo Dot, filtros HDR y optimizaciones sólidas.
...
* **Revestimiento**\
  El revestimiento permite definir una segunda capa de material por encima del material base. Se puede utilizar para simular pintura de coches o películas en superficies metálicas.\
  ...
  * **percha**: Rugosidad de la capa de recubrimiento.
  ...
  Nota: El revestimiento requiere el nuevo sombreado &quot;physically\_metallic\_roughness\_coated&quot;.
...
* **Dispersión subsuperficial**\
  ...
  * **dispersión**: Controla la intensidad de la difusión de luz dentro del material.
  ...
  Nota: Subsurface requiere el nuevo sombreado &quot;physically\_metallic\_roughness\_sss&quot; . El color de dispersión se puede controlar en los parámetros del sombreado.
...
* **Luz de línea**: Genere una luz con forma de línea y cambie su posición en la vista 2D. Tiene opciones similares a la luz plana, excepto que está diseñado para formas largas y delgadas como las luces de neón.
