...
**Substance Designer 2019.3** presenta la gestión de color con compatibilidad con OpenColorIO, así como actualizaciones de panaderos mejoradas y un nuevo nodo de atlas scatter.
...
Substance Designer ahora es compatible con la gestión de color, que permite controlar cómo se interpretan y transforman los colores. Esta característica es compatible con [OpenColorIO](https://opencolorio.org/), un sistema de administración de color muy usado en la industria del entretenimiento y los efectos visuales.

* **Configurando la administración de color en la configuración principal**\
  De forma predeterminada, el Substance Designer se configurará en modo &quot;heredado&quot;, lo que significa que no cargará ninguna configuración específica y seguirá funcionando como antes. Para cambiar a OpenColorIO, por ejemplo, basta con ir a la configuración principal y, a continuación, en la configuración del proyecto para configurarla y habilitarla.
...
>[!NOTE]
>
> La Curvatura anterior del panadero de mallas ya no se usa. Se recomienda cambiar a la nueva versión.

### Oclusión ambiental mejorada de Mesh Baker

![](../../../assets/banner-ao-v2.png)

La Oclusión ambiental del panadero de malla ahora tiene un nuevo ajuste llamado &quot;Plano de tierra&quot; que simula un plano bajo la malla para producir oclusión de tierra. Esto puede ayudar a producir un resultado de aspecto más interesante para la geometría estática o los objetos no orgánicos. El plano de tierra se encuentra en la parte inferior del cuadro delimitador de la malla de forma predeterminada, pero se puede seguir avanzando con una configuración específica.
...
* **Visible si ahora se tiene en cuenta para herramientas de transformación Gizmo 2D**\
  Cuando un gizmo de transformación 2D tiene una condición Visible If, ahora se puede ocultar en la vista 2D, lo que lo hace contextual a los parámetros.
