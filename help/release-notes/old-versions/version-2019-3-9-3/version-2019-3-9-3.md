---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/release-notes/old-versions/version-2019-3-9-3.html"
breadcrumb-title: ''
...
Para obtener más información, consulte la documentación de [Curvatura de malla](https://experienceleague.adobe.com/es/docs/substance-3d/bakers/bakers-settings/curvature-from-mesh).
...
Para obtener más información, consulte la documentación de [Oclusión ambiental de Mesh](https://experienceleague.adobe.com/es/docs/substance-3d/bakers/bakers-settings/ambient-occlusion-from-mesh).
...
* [UI] El botón para mostrar todos los elementos de la barra inferior del vista 2D no está visible
...
* [Vista 3D] No se pueden importar OBJ con varios espacios
* [Gestión de color] OCIO configuración no se tiene en cuenta al publicar sbsar
