---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/release-notes/version-2021-1-11-1.html"
breadcrumb-title: ''
...
Para ello, solo tienes que usar la acción de escena **Archivo > Exportar** en la **vista 3D**. Para obtener más información, consulte la [página de documentación](../../interface/3d-view/3d-view.md) dedicada.
...
* **Crear carpetas al exportar mapas de bits**\
  Al exportar mapas de bits desde un gráfico, ahora es posible especificar barras para crear carpetas y subcarpetas cuando no existen. Esto ayuda a organizar los mapas de bits por gráfico en su propia carpeta, por ejemplo, mediante: **project/$(graph)/$(identifier)**.

* **SBSRender ahora admite perfiles Adobe ACE y ICC**\
  El proceso SBSRender (parte del conjunto de herramientas de automatización) ahora puede procesar salidas de Substance con una gestión de color adecuada al utilizar el motor ACE de Adobe.
