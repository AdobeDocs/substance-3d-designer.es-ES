...
Una vez más, los usuarios avanzados pueden configurar *asignaciones de texturas personalizadas* definidas por un gráfico de funciones.
...
* **Operadores** combinan o replican formas de forma sencilla o compleja según el nodo: desde simples operadores booleanos hasta morfos, conchas y simetrías, amplían dramáticamente las posibilidades de qué tipo de forma 3D se puede lograr
* **Transformaciones** te permite ajustar la posición, la rotación y el tamaño de las formas como puedes esperar y más allá con las curvas, las torceduras y el alargamiento.
...
<table style="border: none; margin-top: 32px; margin-bottom: 32px">
    <tr style="vertical-align: top; border: 0">
        ...
        <td style="width: 60%; border: 0">
            <img src="../../compositing-graphs/nodes-reference-for-com/node-library/values/constant.resources/constants-float-01.png" alt="Nodo &apos;Float&apos; constante" />
        </td>
    </tr>
</table>
...
MaterialX ha ganado tracción rápidamente en las industrias de gráficos de ordenador, y puede ser transportado por archivos USD para la portabilidad completa de escenas a través de DCC y renderizadores.
...
* [Vista 3D] Asegúrese de que el modelo de material sea persistente al cambiar entre representadores 3D y cambios en la definición de materiales
están sincronizados
