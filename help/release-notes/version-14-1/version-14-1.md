---
helpx_url: "https://helpx.adobe.com/es/substance-3d-designer/release-notes/version-14-1.html"
breadcrumb-title: ''
...
![splines de Dispersión en splines](version-14-1.resources/fond.png)
...
![Dispersión spline en animación spline 1](version-14-1.resources/spline1.gif){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![splines de Dispersión en splines 2](version-14-1.resources/spline2.gif){zoomable="yes"}
...
![Alinear nodos](version-14-1.resources/alignment.gif){zoomable="yes"}
...
![Muestra de color: con la herramienta &#x200B;](version-14-1.resources/color-sampler-demo.gif "Muestra de color: usar la herramienta"){width="640px" zoomable="yes"}
...
![Barra de herramientas de búsqueda](version-14-1.resources/search-53.png){width="640px"}
...
[![splines de dispersión de vídeo en splines](version-14-1.resources/video_spline.png)](https://www.youtube.com/watch?v=aUUWV1dYQdI)

</td>
<td style="border: 0;" valign="top">

[![características de experiencia de usuario de vídeo](version-14-1.resources/video_ux.png)](https://www.youtube.com/watch?v=LwexybAEjaI)
