...
## ![(error)](../../assets/error.svg) Paquete dependiente no válido
...
## ![(error)](../../assets/error.svg) Compruebe que el alias *&#39;X&#39;* está definido en el proyecto
...
![&#39;Comprobar alias definido&#39; solución](../../assets/warnings-dep-alias.gif "&#39;Comprobar alias definido&#39; solución")

## ![(error)](../../assets/error.svg) No se encuentra ningún archivo que coincida con este recurso
...
## ![(error)](../../assets/error.svg) No se encontró el archivo vinculado
...
## ![(error)](../../assets/error.svg) No se encuentra el espacio de color
...
Solución ![&#39;No se encuentra el espacio de color&#39;](../../assets/warnings-dep-color-space.gif "&#39;Solución no se encuentra el espacio de color&#39;")
...
1. <b>Seleccionar otro gráfico</b>
   ...
   ![&#39;Recurso de referencia no encontrado&#39; solución 1](../../assets/warnings-dep-udim-graph.gif "&#39;Recurso de referencia no encontrado&#39; solución 2")
...
![&#39;Los mosaicos UV se asignan varias veces&#39; solución](../../assets/warnings-dep-udim-same.gif "&#39;Los mosaicos UV se asignan varias veces&#39; solución")
...
![&#39;Solución de mosaicos UV no válida](../../assets/warnings-dep-udim-invalid.gif "&#39;Solución de mosaicos UV no válida")
