...
Substance 3D Designer se puede configurar para usar [OpenColorIO](https://opencolorio.org/) (OCIO) o Adobe Color Engine (ACE) para la administración de color. Esto te permite tener *transformes de color coherentes* y visualización de imágenes en varias aplicaciones.
...
> 
> OpenColorIO usuarios deben utilizar espacios de color OpenColorIO coincidentes para sus monitores.\
> Los usuarios de ACE de Adobe deben asegurarse de que los perfiles ICC seleccionados *en el sistema operativo* coincidan con *sus* monitores.
...
Al utilizar el modo de OpenColorIO para la gestión de color, Designer utilizará la información almacenada en un <b>archivo de configuración</b> (*\*.config*) para realizar transformes de color, identificar espacios de color y establecer valores predeterminados.
...
### Predeterminados de visualización 2D y Vista 3D
...
Al utilizar el modo de ACE de Adobe para la administración de color, Substance 3D Designer utilizará la información almacenada en <b>Perfiles ICC</b> (*\*.icc / \*.icm*) para realizar transformes de color e identificar espacios de color.
...
### Espacio predeterminado de visualización 2D y Vista 3D
...
Puede elegir usar <b>ACE sRGB</b> *tonemapping* en el <b>Vista 3D</b> para que coincida con la salida de otro software, como *[Unreal Engine](https://docs.unrealengine.com/en-US/Engine/Rendering/PostProcessEffects/ColorGrading/index.html)*.
...
Puede asignar un <b>espacio de color</b> (OCIO) o un <b>perfil ICC</b> (ACE de Adobe) a los mapas de bits importados y vinculados.
...
Al utilizar el cuadro de diálogo <b>Exportar salidas</b>, es posible asignar un <b>espacio de color</b> (OCIO) o adjuntar un <b>perfil ICC</b> (ACE de Adobe) para *cada salida*.\
...
También puedes asignar un espacio de color (OCIO) o adjuntar un perfil ICC (ACE de Adobe) a las imágenes *guardadas* del [vista 2D](../interface/2d-view/2d-view.md).
...
Puede activar o desactivar *la gestión de color* y cambiar la *visualización transformada* de la vista en cualquier momento mediante el menú desplegable de la barra de herramientas de visualización.

![Configuración del espacio de color en el vista 2D](color-management.resources/2019-3-0-clr-mgt-display-toolbar.png "Configuración del espacio de color en el vista 2D"){width="512px"}
