...
El botón <b>Actualizar</b> se puede usar para *actualizar* la lista de complementos. Esto resulta útil cuando los complementos se cargan mediante la API de Python.

>[!NOTE]
>
> Si el complemento es un *módulo* (es decir, un directorio), se puede cargar eligiendo el archivo <b>\_\_init\_\_.py</b> dentro del módulo.
