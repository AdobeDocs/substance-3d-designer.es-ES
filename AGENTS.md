...
Este archivo proporciona orientación a los agentes de IA y a los asistentes de código (GitHub Copilot, Claude, etc.) cuando se trabaja con código en este repositorio.
